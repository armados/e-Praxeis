...
public class FavoritesUnitsAdapter extends RecyclerView.Adapter<FavoritesUnitsAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public FavoritesUnitsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_watch_list, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoritesUnitsAdapter.ViewHolder holder, int position) {
