...
public class FavoritesOrganizationsFragment extends BaseFragment {

    private final String TAG = getClass().getSimpleName();

    private final FavoritesOrganizationsAdapter mAdapter = new FavoritesOrganizationsAdapter();
    ...
    private void updateUI() {
        final List<FavoriteEntity> list = Database.getInstance(getActivity()).getFavoriteDao().getAll(FavoriteEntity.ORGANIZATION);
