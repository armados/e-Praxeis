...
public class FavoritesOrganizationsAdapter extends RecyclerView.Adapter<FavoritesOrganizationsAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public FavoritesOrganizationsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_watch_list, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoritesOrganizationsAdapter.ViewHolder holder, int position) {
