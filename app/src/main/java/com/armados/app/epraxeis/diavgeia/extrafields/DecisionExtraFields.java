package com.armados.app.epraxeis.diavgeia.extrafields;
...
import com.armados.app.epraxeis.diavgeia.extrafields.common.RelatedDecision;
    ...
    protected String showAmount(final Context context, final amountWithVAT amountWithVAT) {
        if (amountWithVAT == null || amountWithVAT.getAmount() == 0) {
            ...
            DictionaryEntity currency = Database.getInstance(context)
                    .getDictionaryDao()
                    .getEntry(Configuration.DICTIONARY_CURRENCIES, amountWithVAT.getCurrency());
            if (currency != null)
