...
public class SimpleAdapterLite extends RecyclerView.Adapter<SimpleAdapterLite.ViewHolder> {
    ...
    @NonNull
    @Override
    public SimpleAdapterLite.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_view_simple_lite, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SimpleAdapterLite.ViewHolder holder, int position) {
