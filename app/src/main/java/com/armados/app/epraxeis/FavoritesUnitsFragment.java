...
public class FavoritesUnitsFragment extends BaseFragment {

    private final String TAG = getClass().getSimpleName();

    private final FavoritesUnitsAdapter mAdapter = new FavoritesUnitsAdapter();
    ...
    private void updateUI() {
        final List<FavoriteEntity> list = Database.getInstance(getActivity()).getFavoriteDao().getAll(FavoriteEntity.UNIT);
