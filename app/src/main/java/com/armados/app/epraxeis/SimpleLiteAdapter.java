...
public class SimpleLiteAdapter extends RecyclerView.Adapter<SimpleLiteAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public SimpleLiteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_view_simple_lite, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SimpleLiteAdapter.ViewHolder holder, int position) {
