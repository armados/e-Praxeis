...
public class FavoriteOrganizationAdapter extends RecyclerView.Adapter<FavoriteOrganizationAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public FavoriteOrganizationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_watch_list, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoriteOrganizationAdapter.ViewHolder holder, int position) {
