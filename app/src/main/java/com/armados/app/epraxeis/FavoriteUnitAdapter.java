...
public class FavoriteUnitAdapter extends RecyclerView.Adapter<FavoriteUnitAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public FavoriteUnitAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_watch_list, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoriteUnitAdapter.ViewHolder holder, int position) {
