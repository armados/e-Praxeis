...
public class FavoritesSignersAdapter extends RecyclerView.Adapter<FavoritesSignersAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public FavoritesSignersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_watch_list, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoritesSignersAdapter.ViewHolder holder, int position) {
